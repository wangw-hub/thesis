...
能力与最小权限原则[5]与能力机制[13]、令牌授权框架[11]及其时间相关声明[12]、许可链共识[6]与数据库原子语义[7]
...
[6] Hyperledger Besu Documentation. QBFT consensus protocol[EB/OL]. [2026-08-02]. https://besu.hyperledger.org/private-networks/how-to/configure/consensus/qbft.

[7] PostgreSQL Global Development Group. PostgreSQL 16 Documentation: INSERT[EB/OL]. [2026-08-02]. https://www.postgresql.org/docs/16/sql-insert.html.

[8] Josefsson S, Liusvaara I. Edwards-Curve Digital Signature Algorithm (EdDSA)[S]. RFC 8032, 2017.

[9] Efron B. Bootstrap Methods: Another Look at the Jackknife[J]. The Annals of Statistics, 1979, 7(1): 1-26. DOI: 10.1214/aos/1176344552.

[10] Barnes R, Bhargavan K, Lipp B, Wood C. Hybrid Public Key Encryption[S]. RFC 9180, 2022.

[11] Hardt D (Ed.). The OAuth 2.0 Authorization Framework[S]. RFC 6749, 2012.

[12] Jones M, Bradley J, Sakimura N. JSON Web Token (JWT)[S]. RFC 7519, 2015.

[13] Dennis J B, Van Horn E C. Programming semantics for multiprogrammed computations[J]. Communications of the ACM, 1966, 9(3): 143-155. DOI: 10.1145/365230.365252.

[14] Benet J. IPFS - Content Addressed, Versioned, P2P File System[EB/OL]. arXiv:1407.3561, 2014[2026-08-02]. https://arxiv.org/abs/1407.3561.

[15] Bethencourt J, Sahai A, Waters B. Ciphertext-Policy Attribute-Based Encryption[C]//Proceedings of the 2007 IEEE Symposium on Security and Privacy. IEEE, 2007: 321-334. DOI: 10.1109/SP.2007.11.

[16] Rouhani S, Belchior R, Cruz R S, Deters R. Distributed attribute-based access control system using permissioned blockchain[J]. World Wide Web, 2021, 24(5): 1617-1644. DOI: 10.1007/s11280-021-00874-7.
