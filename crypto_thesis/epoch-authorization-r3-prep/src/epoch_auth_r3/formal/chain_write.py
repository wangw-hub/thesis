...
class FormalChainWritePlanV1:
    ...
    transactionSequence: tuple[FormalChainWriteStepV1, ...]
...
class FormalChainWriteAdmissionGuardV1:
    @staticmethod
    def admit(
        *, plan: FormalChainWritePlanV1, visibility: dict,
